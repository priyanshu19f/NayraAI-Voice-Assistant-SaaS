                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 ">
                    ...
                    <div className="rounded-3xl p-8 bg-gradient-to-r from-purple-600 to-emerald-500 text-white shadow-lg ">
                        ...
                        <button
                            ...
                            className={`mt-8 h-14 w-full rounded-2xl shadow-sm font-semibold transition ${user.plan === "pro" ? "bg-emerald-200 text-black cursor-default" : "bg-white text-[#081028] cursor-pointer hover:scale-102 hover:shadow-md "} `}
                        >
                            {user?.plan === "pro"
                                ? "Active Plan"
                                : "Upgrade Now"}
