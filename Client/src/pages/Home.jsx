                ...
                <div className="relative max-w-6xl mx-auto ">
                    ...
                    <div className="text-center mt-10 sm:mt-12">
                        <h1 className="max-w-5xl mx-auto text-[42px] leading-[52px] sm:text-6xl sm:leading-[72px] lg:text-7xl lg:leading-[88px] font-black tracking-[-0.04em] text-[#081028] ">
                            ...
                            <br className="hidden sm:block" /> to your website
                        </h1>
                        <p className="max-w-2xl mx-auto mt-7 text-sm sm:text-lg lg:text-xl text-[#64748b] leading-relaxed px-2 ">
                            Create a smart voice-enabled assistant that talks to
                            visitors, answers questions and helps users navigate
                ...
                <div className="max-w-6xl mx-auto ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 ">
                        {STEPS.map((s, i) => (
                            <div
                                key={i}
                                className="group bg-[#f8fafc] hover:bg-white border border-gray-200 rounded-[28px] p-7 transition-all hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)] "
                            >
