            ...
            >
                ...
                <div className="absolute top-4 right-4 sm:top-5 sm:right-5 z-30 flex items-center gap-2 ">
                    <button
                        ...
                        className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#050816] border transition-all cursor-pointer ${theme === "dark" ? "border-purple-400 scale-110" : "border-white/20"} `}
                    />

                    <button
                        onClick={() => setTheme("light")}
                        className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white border transition-all cursor-pointer ${theme === "light" ? "border-blue-400 scale-110" : "border-gray-300"} `}
                    />
                    ...
                    <button
                        ...
                        className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-gradient-to-r from-emerald-400 to-green-500 border transition-all cursor-pointer ${theme === "neon" ? "border-emerald-300 scale-110" : "border-trasparent"} `}
                    />
                </div>
                <div className="relative z-20 flex flex-col items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8 ">
                    ...
                    <div className="text-center">
                        ...
                        <p
                            className={`mt-4 sm:mt-1 text-[13px] sm:text-[15px] md:text-[16px] leading-5 sm:leading-7 max-w-[280px] mx-auto ${current.sub} `}
                        >
